...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'A teleoperated robotic assistant that democratizes precision soldering. It uses a 6-DOF robotic arm to mimic a 3D-printed pen controller in real-time. By applying an EMA filter to remove human tremors, it turns a shaky hand into surgeon-like precision. It also features an AR mode for virtual soldering practice.',
